    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-8 mx-auto">
                ...
                <form action="console.php?action=admin" method="post"  novalidate="novalidate">
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary btn-xl" id="sendMessageButton">Se connecter</button>
                    </div>
                </form>
            </div>
        </div>
